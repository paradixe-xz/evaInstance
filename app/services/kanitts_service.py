...
class KaniTTSService:
    def __init__(self):
        ...
        self.timeout = getattr(self.settings, 'KANITTS_TIMEOUT', 30)
    ...
    def generate_speech(self, text: str, speaker: str = None, language: str = None) -> Optional[str]:
        ...
        Returns:
            URL del archivo de audio generado o None si hay error
        """
        ...
        try:
            ...
            logger.error(f"Error generando audio con KaniTTS: {e}")
            return None
